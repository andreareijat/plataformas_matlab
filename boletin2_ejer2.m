...
%MODIFICAMOS EL DIAGRAMA ORIGINAL, MOVIENDO LA RAMA DE H1 DELANTE G3, DE AHI OBTENEMOS H1/G3
feedback_2 = feedback(serie2,H1/G3,1); %reduccion en paralelo con realimentacion positiva
